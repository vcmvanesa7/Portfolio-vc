...
export const getDictionary = async (
  ...
  const dictionaries = {
    es: {
      ...
      nav: () => import("./nav/es.json").then((mod) => mod.default as DictionarySection),
      contact: () => import("./contact/es.json").then((mod) => mod.default as DictionarySection),
      projects: () => import("./projects/es.json").then((mod) => mod.default as DictionarySection),
    },
    en: {
